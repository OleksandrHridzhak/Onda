...
function serializeCalendarEvent(ev: any): CalendarEntry {
    return {
        ...
        repeatDays: ev.repeatDays ? safeJsonParse<number[] | undefined>(ev.repeatDays, undefined) : undefined,
...
export async function getCalendarEvents(filter?: CalendarEventsFilter): Promise<DbResult<CalendarEntry[]>> {
    try {
