  ...
  return (
    ...
    >
      ...
      <div className="relative z-50 flex h-full w-full flex-col border border-border bg-background md:border-l-0 animate-fade-in">
        ...
        <div className="grid flex-1 min-h-0 grid-cols-1 gap-4 overflow-auto p-6 md:grid-cols-2 lg:grid-cols-3 custom-scroll md:hide-scrollbar">
            ...
            return (
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-semibold text-text">{type.label}</div>
