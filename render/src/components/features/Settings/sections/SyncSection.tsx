        ...
        <SettingsTemplate title="Cloud Sync">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-textMuted">
                            Synchronize your data across devices. Changes sync
                            automatically as you type (Notion-style). Data is
                            also pulled when you open the app or return from
                            tray. No manual saving needed!
                        </p>
                    </div>
                </div>
            ...
            <div className="space-y-2">
                ...
                <InputText
                    ...
                    className="w-full px-4 py-2.5 rounded-lg bg-cellBg border border-border text-text placeholder-textSubtle focus:ring-2 focus:ring-primaryColor focus:border-transparent transition-all"
                />
                <p className="text-xs text-textSubtle">
                    Use localhost:3001 for local testing, or your cloud server
                    URL
                </p>
            </div>
                ...
                <div className="p-4 rounded-lg bg-cellBg border border-border space-y-3">
                    <div className="flex items-center gap-3">
                        {syncStatus.autoSyncActive ? (
                            ...
                            <WifiOff size={18} className="text-textMuted" />
                        )}
